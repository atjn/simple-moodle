...
if (filter.test(window.location.hostname)) {
	...
	if (getEnabled()) {
		(async () => {
			...
			globalStyle.href = browser.runtime.getURL("styles/global.css");
		...
		const load = () => {
			...
			if (document.querySelector("section.block_myoverview")) {
				...
				style.href = browser.runtime.getURL("styles/overview.css");
				document.head.appendChild(style);

				const script = document.createElement("script");
				script.type = "module";
				script.src = browser.runtime.getURL("scripts/overview.js");
				...
				const style = document.createElement("link");
				style.rel = "stylesheet";
				style.href = browser.runtime.getURL("styles/course.css");
				document.head.appendChild(style);
				...
				const style = document.createElement("link");
				style.rel = "stylesheet";
				style.href = browser.runtime.getURL("styles/calendar.css");
				document.head.appendChild(style);
			}
		};
